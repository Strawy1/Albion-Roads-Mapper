...
.callout {
  @apply text-[9px] uppercase font-bold tracking-widest px-3 py-1.5 rounded-lg border border-dashed bg-gray-700/80 backdrop-blur-md border-red-800 text-red-600 cursor-pointer;
