...
- [Gotchas & invariants](albion-mapper-gotchas.md) — server-owned positions, full-array WS broadcasts, sender-exclusion trap on split edits, delete+reinsert paths, handles-win rotation healing, known schema drift
