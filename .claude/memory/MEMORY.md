...
- [Backend deploy pipeline](albionroads-deploy-pipeline-rollout.md) — live since 27 Jul 2026: Actions → webhook → 10.0.5.10; the off-repo infra facts, plus what update.sh does is still unverified
